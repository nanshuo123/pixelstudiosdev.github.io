...
<Tabs>
    <TabItem value="new" label="v2.0" default>
        ...
        | [CustomCrops](https://polymart.org/product/2625/) | Specifically look `HARVEST` `PLACE` | Planting and Harvesting CustomCrops Crops | `crop_age` |
        | [CustomFishing](https://polymart.org/resource/2723/) | `CUSTOM_FISHING` | Catch CustomFishing's loot | `custom_fishing_loot` |
        | [MythicMobs](https://polymart.org/product/4675/) | `KILL` | Kill the MythicMbos | `mm:xx``mythicmobs:xx` |
        | [EconomyShopGUI](https://www.spigotmc.org/resources/economyshopgui.69927/) | `ECONOMY_SHOP_GUI:BUY` | Buy an item | `items` |
        | [EconomyShopGUI](https://www.spigotmc.org/resources/economyshopgui.69927/)| `ECONOMY_SHOP_GUI:SELL` | Sell an item | `items` |
    </TabItem>
